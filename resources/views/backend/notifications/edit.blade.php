...
<div class="col-md-12">
	<div class="card card-default">
		<div class="card-header">
			<h4 class="card-title text-center">  Notification Edit</h4>
		</div>
		<div class="card-body">
			<form action="{{ route('notification.update',$notification->id) }}" method="post">
				@csrf
						<div class="form-group">
							...
							<input type="text" name="title" value="{{ $notification->title}}"  id="address" class="form-control">
						...
						<label for="district" class="col-form-label"> Seller </label>
							...
							<select class="form-control demo1" name="user[]" id="demo1" data-max="" multiple="multiple" style="">
						...
						<label for="district" class="col-form-label"> Merchant </label>
							...
							<textarea class="form-control" rows="4" name="message">{{ $notification->message}}</textarea>
						</div>



						<div class="switcher">
							<input type="checkbox" name="status" id="switcher_checkbox_1" {{$notification->status == 1  ? "checked" : ''}} value="1">
