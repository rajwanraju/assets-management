    ...
    <form method="post" action="{{route('assets.store')}}" enctype="multipart/form-data">
      <div class="row">
        <div class="col-lg-8 col-md-10 col-sm-10 col-12 offset-lg-2 offset-md-2 offset-sm-2">
          <h1 class="text-center text-danger">Assets Adding</h1><br>

          {!! csrf_field() !!}
          <div class="form-group row">
            <label class="col-3">Title<span class="text-danger">*</span></label>
            <input type="text" class="form-control col-9" name="name" value="{{old('name')}}">
          </div>

          <div class="form-group row">
            <label class="col-3">Url Slug<span class="text-danger">*</span> </label>
            <input type="text" class="form-control col-9" name="slug" value="{{old('slug')}}">
            ...
            <input type="text" class="form-control col-9" name="asset_sku" value="{{old('asset_sku')}}">
            ...
            <!-end form-group row -->
              ...
              <!-begin form-group row -->
                <div class="form-group row">
                  ...
                  <div class="col-9">
                    <textarea class="summernote" name="description">{{old('asset_sku')}}</textarea>
                  </div>
                ...
                <!-end form-group row -->
                 ...
                 <!-begin form-group row -->
                  ...
                  <!-end form-group row -->
                    ...
                    <div class="form-group">
                     <button type="submit" class="btn btn-success btn-lg float-right">Submit & Save</button>
                   </div>
